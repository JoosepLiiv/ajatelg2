...
class Plugin extends PluginBase
{
    ...
    private function getTextFilters($twig)
    {
        ...
        return [
            ...
            'etdate' => function($time, $format) {
                if(! $time instanceof Carbon) {
                    $time = Carbon::parse($time);
                }

                if(Lang::getLocale() == 'et') {
                    $monthsPlural = array('jaanuar', 'veebruar', 'märts', 'aprill', 'mai', 'juuni', 'juuli', 'august', 'september', 'oktoober', 'november', 'detsember');
